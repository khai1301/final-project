...
class FortifyServiceProvider extends ServiceProvider
{
    ...
    {
        // Bind view responses (required by Fortify)
        $this->app->singleton(
        ...
        $this->app->singleton(
            ...
            \Laravel\Fortify\Http\Responses\RegisterViewResponse::class
        );

        $this->app->singleton(
            \Laravel\Fortify\Contracts\RequestPasswordResetLinkViewResponse::class,
            \Laravel\Fortify\Http\Responses\RequestPasswordResetLinkViewResponse::class
        );

        $this->app->singleton(
            \Laravel\Fortify\Contracts\ResetPasswordViewResponse::class,
            \Laravel\Fortify\Http\Responses\ResetPasswordViewResponse::class
        );
    }
    ...
    public function boot(): void
    {
        ...
        Fortify::registerView(function () {
            ...
            return view('auth.register', compact('provinces', 'wards'));
        });
